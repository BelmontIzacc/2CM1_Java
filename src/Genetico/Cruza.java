...
public class Cruza {                    
    ...
    public static Individuo cruzaOR (Individuo madre, Individuo padre){
    ...
    public static Individuo cruzaAND (Individuo madre, Individuo padre) {
        int[] gen = new int[madre.getGenotipo().length];
    ...
    public static Individuo cruzaNAND (Individuo madre, Individuo padre) {
        int[] gen = new int[madre.getGenotipo().length];
    ...
    public static Individuo cruzaNOR (Individuo madre, Individuo padre) {
        int[] gen = new int[madre.getGenotipo().length];
        
        for(int x = 0 ; x < madre.getGenotipo().length ; x++){
            if((madre.getGenotipo()[x]==0) && (padre.getGenotipo()[x]==0)){
                gen[x]=1;
            }else{
                gen[x]=0;
            }
    ...
    public static Individuo cruzaXOR (Individuo madre, Individuo padre) {
        int[] gen = new int[madre.getGenotipo().length];
    ...
    public static Individuo cruzaNOT (Individuo madre, Individuo padre) {
        int[] gen = new int[madre.getGenotipo().length];
        
        Individuo aux = cruzaOR(madre,padre);
        for(int x = 0 ; x < madre.getGenotipo().length ; x++){
            if(aux.getGenotipo()[x]==1) {
                gen[x] = 0;
            } else {
                gen[x] = 1;
            }
    ...
    public static Individuo cruzaXNOR (Individuo madre, Individuo padre) {
        int[] gen = new int[madre.getGenotipo().length];

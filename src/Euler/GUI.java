...
public class GUI extends javax.swing.JFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        String fucion = funcion.getText();
        String xi = xinicial.getText();
        String yi = yinicial.getText();
        String ho = h.getText();
        String e = elementos.getText();
        
        mostrar_puntos mp = new mostrar_puntos();
        mp.setValores(fucion,xi,yi,ho,e);
        mp.datos();
        mp.setVisible(true);
        this.dispose();
